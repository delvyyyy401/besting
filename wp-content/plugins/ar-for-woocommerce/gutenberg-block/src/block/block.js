 ...
 */
registerBlockType( 'cgb/block-arwc-guten-block', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'AR For WooCommerce' ), // Block title.
	...
	keywords: [
		__( 'AR For WooCommerce' ),
		__( 'AR For WooCommerce Block' ),
	...
	edit:  ( props ) => {
    	...
    	return [
	        ...
	        <div>	            
                ...
                <Disabled>
					<ServerSideRender block="cgb/block-arwc-guten-block" attributes={ props.attributes } />
				</Disabled>	            
	        </div>
	    ]
